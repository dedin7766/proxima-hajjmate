    ...
    return (
        <div className="mt-auto pt-4 space-y-2 text-md">
            ...
            <div className="flex justify-between items-center">
                ...
                <input id="discount" type="number" placeholder="0" className="w-32 text-right border bg-background rounded-md px-2 py-1" value={discount} onChange={(e) => onDiscountChange(e.target.value)} onFocus={(e) => e.target.select()} />
            </div>
            <div className="flex justify-between items-center">
                <label htmlFor="tax" className="text-muted-foreground">Pajak (%)</label>
                <input id="tax" type="number" placeholder="0" className="w-32 text-right border bg-background rounded-md px-2 py-1" value={taxRate} onChange={(e) => onTaxRateChange(e.target.value)} onFocus={(e) => e.target.select()} />
            </div>
